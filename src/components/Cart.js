...
let OrderDetailsView = ({ items = [] }) => {
  return (<><Box className="cart"><Box display="flex" flexDirection="column" padding="1rem"><h2>Order Details</h2>
  <Box
            display="flex"
            flexDirection="row"
  ...
  return (
    <>
      <Box className="cart">
        ...
        {isReadOnly ? null : (<Box display="flex" justifyContent="flex-end" className="cart-footer"><Button
              color="primary"
              variant="contained"
